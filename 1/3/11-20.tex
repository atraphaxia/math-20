...
\subsection{} \[4 - 3x - x^2 \ge 0\]
	\phxproof{
		\phxeqb{}{$x^2 + 3x - 4 \le 0$}{}
		\phxeqs{}{$(x + 4)(x - 1) \le 0$}{Factor by grouping.}
		\phxeqs{}{$N_C \in \{-4, 1\}$}{}
		\phxsign{}{
...
\subsection{} \[4x^2 + 4x > -1\]
	\phxproof{
		...
		\phxeqf{}{$x \in \mathbb{R} \setminus \{-\frac{1}{2}\}$}{The square of a real number is always greater than or equal to zero. $x = -\frac{1}{2}$ is not included since then the inequality will become $0 > 0$.}
	}
...
\subsection{} \[x - 2 \ge (x - 2)(2x^2 - x - 14)\]
	\phxproof{
		\phxeqb{}{$x - 2 \ge 2x^3 - x^2 - 14x - 4x^2 + 2x + 28$}{}
		\phxeqs{}{$x - 2 \ge 2x^3 - 5x^2 - 12x + 28$}{}
		\phxeqs{}{$2x^3 - 5x^2 - 13x + 30 \le 0$}{}
		\phxeqs{}{$p \in \{\pm 1, \pm 2, \pm 3, \pm 5, \pm 10, \pm 15, \pm 30\}$}{Factor using rational root theorem.}
		\phxeqs{}{$q \in \{\pm 1, \pm 2\}$}{}
		\phxeqs{}{$\frac{p}{q} \in \{\pm 1, \pm \frac{1}{2}, \pm 2, \pm 3, \pm \frac{3}{2}, \pm 5, \pm \frac{5}{2}, \pm 10, \pm 15, \pm \frac{15}{2}, \pm 30\}$}{}
		\phxsdiv{}{1}{2x^3 - 5x^2 - 13x + 30}{}
		\phxsdiv{}{-1}{2x^3 - 5x^2 - 13x + 30}{}
		\phxsdiv{}{2}{2x^3 - 5x^2 - 13x + 30}{}
		\phxeqs{}{$(x - 2)(2x^2 - x - 15) \le 0$}{}
		\phxeqs{}{$(x - 2)(2x^2 - 6x + 5x - 15) \le 0$}{Factor by grouping.}
		\phxeqs{}{$(x - 2)(2x + 5)(x - 3) \le 0$}{}
		\phxeqs{}{$N_C \in \{-\frac{5}{2}, 2, 3\}$}{}
		\phxsign{}{
			\tkzTabInit[lgt = 4, espcl = 1, deltacl = 0]
		...
		\phxeqf{}{$x \in (-\infty, -\frac{5}{2}] \cup [2, 3]$}{}
	}

\subsection{} \[x(2x^2 - 5x - 12) \ge 2x^2 - 5x - 12\]
	\phxproof{
		\phxeqb{}{$2x^3 - 5x^2 - 12x \ge 2x^2 - 5x - 12$}{}
		\phxeqs{}{$2x^3 - 7x^2 - 7x + 12 \ge 0$}{}
		...
		\phxeqs{}{$(x - 1)(2x^2 - 5x - 12) \ge 0$}{}
		\phxeqs{}{$(x - 1)(2x^2 - 8x + 3x - 12) \ge 0$}{Factor by grouping.}
		\phxeqs{}{$(x - 1)(2x + 3)(x - 4) \ge 0$}{}
		\phxeqs{}{$N_C \in \{-\frac{3}{2}, 1, 4\}$}{}
		\phxsign{}{
			\tkzTabInit[lgt = 4, espcl = 1, deltacl = 0]
		...
		\phxeqf{}{$x \in [-\frac{3}{2}, 1] \cup [4, +\infty)$}{}
	}
...
\subsection{} \[\frac{x}{x - 1} > -1\]
	\phxproof{
		...
		\phxeqf{}{$x \in (-\infty, \frac{1}{2}) \cup (1, +\infty)$}{}
	}

\subsection{} \[\frac{x - 1}{2x + 5} \ge 0\]
	\phxproof{
		\phxeqb{$x \ne -\frac{5}{2}$}{$N_C \in \{-\frac{5}{2}, 1\}$}{}
		\phxsign{}{
			\tkzTabInit[lgt = 2, espcl = 1, deltacl = 0]
		...
		\phxeqf{}{$x \in (-\infty, -\frac{5}{2}) \cup [1, +\infty)$}{}
	}
