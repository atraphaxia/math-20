...
\anotegroup{Quadratics}{
	\anote{Definition}{qd}{%
		...
		\[ax^2 + bx + c = 0\]
		These equations have either one or two solutions.
	}
...
\anotegroup{Inequalities}{
	\anote{Quadratics}{iq}{%
		In order to solve quadratic inequalities, first rewrite it in standard form, factor, then create a table of signs.
	}
